        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Edu" />
              </Input.Root>

              <Input.Root>
                <Input.Control defaultValue="Reichert" />
              </Input.Root>
            </div>
            <div />
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="edrdesigner@gmail.com"
              />
            </Input.Root>
            <div />
          </div>
              ...
              >
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-xs">
                    SVG, PNG JPG of GIF (max 800x400px)
                  </span>
                </div>
              </label>
          ...
          <div className="mt-5 flex items-center justify-end gap-2 pt-5">
            <button
              type="button"
              className="rounded-lg border border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 shadow-sm hover:bg-zinc-50"
            >
